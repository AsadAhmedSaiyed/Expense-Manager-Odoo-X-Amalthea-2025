          ...
          <tbody>
            {users.map((user) => (
              <tr key={user.id} className="hover:bg-gray-50">
                ...
                <td className="border border-gray-300 px-4 py-2">{user.employee_id}</td>
                <td className="border border-gray-300 px-4 py-2">{user.role}</td>
                <td className="border border-gray-300 px-4 py-2 capitalize">{user.status}</td>
                <td className="border border-gray-300 px-4 py-2">{new Date(user.created_at).toLocaleString()}</td>
                <td className="border border-gray-300 px-4 py-2">{new Date(user.updated_at).toLocaleString()}</td>
              </tr>
            ))}
          </tbody>
        </table>
